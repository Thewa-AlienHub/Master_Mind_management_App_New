...
function ViewIssueComplex({ navigation,route }) {
    ...
    const deleteIssue= async()=>{
      ...
      try {
          ...
          navigation.navigate('IssueList',{ email: issue.email });
  ...
  return (
    <KeyboardAvoidingView style={styles.container} behavior="padding">
      ...
      <View style={styles.headerContainer}>
        <Text style={styles.header}>{IssueNames(issue.collection)}</Text>
        ...
        <View style={{ alignItems: 'center' }}>
                ...
                <View style={styles.ButtonContainer}>
                        ...
                        {loading ? (
                            ...
                            <>
                                <TouchableOpacity style={[styles.button, styles.editButton]} onPress={() => navigation.navigate('EditIssueComplex', { issue: { ...currentIssue, collection: issue.collection, id: issue.id } })}>
...
export default ViewIssueComplex;