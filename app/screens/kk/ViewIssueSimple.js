...
function ViewIssueSimple({ route, navigation }) {
                ...
                <ScrollView>
                        ...
                        <View style={styles.ButtonContainer}>
                            {loading ? (
                                ...
                                <>
                                    <TouchableOpacity style={[styles.button, styles.editButton]} onPress={() => navigation.navigate('EditIssueSimple', { issue: { ...currentIssue, collection: issue.collection, id: issue.id } })}>
...
export default ViewIssueSimple;