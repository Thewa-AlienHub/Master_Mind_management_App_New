      ...
      try {
        if (data) {
          const storageRef = ref(
            storage,
            `gs://uee-project-mm.appspot.com/profilepictures/${data.data.FirstName}.jpeg`
  ...
  return (
    <View style={styles.mainContainer}>
      <View style={styles.headerContainer}>
        <View style={styles.iconContainer}>
          ...
          <View style={styles.logoContainer}>
            <Text style={styles.logotext}>Master Mind</Text>
          </View>
        </View>
      ...
      <View style={styles.detailTextNameContainer}>
        <Text style={styles.detailTextName}>
          {data?.data?.FirstName || "First Name"}
        </Text>
        <Text style={styles.detailTextName}>
          {data?.data?.LastName || "Last Name"}
        </Text>
      </View>
      <ScrollView
      ...
      >
        <View style={styles.detailsCard}>
          <View style={styles.detailTextContainer}>
            ...
            <Text style={styles.detailText}>{data?.data?.role || "Staff"}</Text>
          </View>
          <View style={styles.detailTextContainer}>
            <Text style={styles.label}>Email: </Text>
            <Text style={styles.detailText}>
              {data?.data?.email || "SasinduPraveen705@gmail.com"}
            </Text>
          </View>
          ...
          <View style={styles.detailTextContainer}>
            ...
            <Text style={styles.detailText}>
              {data?.data?.ContactNum || "0765376635"}
            </Text>
          </View>
          ...
          <View style={styles.detailTextContainer}>
            ...
            <Text style={styles.detailText}>
              {data?.data?.Address || "Wallawaththa, Colombo 7"}
            </Text>
          </View>
          <View style={styles.detailTextContainer}>
            <Text style={styles.label}>Monthly Salary: </Text>
            <Text style={styles.detailText}>
              {data?.data?.salary || "40,000LKR"}
            </Text>
          </View>
          <View style={styles.detailTextContainer}>
            <Text style={styles.label}>Available Leaves: </Text>
            <Text style={styles.detailText}>
              {data?.data?.leaves || "8 Casual, 3 Short, 4 Sick"}
            </Text>
          </View>
        </View>
