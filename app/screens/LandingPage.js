    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.SloganContainer}>
                ...
                <Animated.Text style={[styles.Text3, { opacity: text3Opacity }]}>
                    Empowering,
                </Animated.Text>
                ...
                your all in one hub for seamless Living & Smarter Management....
                </Animated.Text>
            </View>
...
const styles = StyleSheet.create({
    ...
    TopBarContainer: {
        ...
        alignItems: 'center',
        position: 'relative',
        height: height * 0.48, // Adjust height for full-screen experience
    },
    titleContainer: {
        alignItems: 'center',
        marginTop: 20,
